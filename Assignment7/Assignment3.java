...
public class Assignment3 {
    ...
    public static void main(String[] args) {
        ...
        s.add(new Employees ("shradha",123,50000,"Devloper"));
        s.add(new Employees ("Sourabh",456,60000,"HR"));
        s.add(new Employees ("Aditya",789,30000,"Mgmt"));
        s.add(new Employees("ashish",111,90000,"Mgmt"));
        s.add(new Employees("gauri",222,10000,"Devloper"));
